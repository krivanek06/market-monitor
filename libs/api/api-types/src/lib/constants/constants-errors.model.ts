...
// simulator
export const SIMULATOR_NOT_ENOUGH_UNITS_TO_SELL = 'Not enough units on the market to buy';
export const SIMULATOR_PARTICIPANT_NOT_FOUND = 'Participant not found';
export const SIMULATOR_PARTICIPANT_DIFFERENT_USER = 'Participant is not the same user';
