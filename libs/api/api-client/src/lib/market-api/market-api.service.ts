...
export class MarketApiService {
  ...
  getStockScreening(screeningValue: StockScreenerValues): Observable<StockScreenerResults[]> {
    return this.apiCache.postData<StockScreenerResults[], StockScreenerValues>(
