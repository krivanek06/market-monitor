...
import { URL_GITHUB, URL_INSTAGRAM, URL_LINKED_IN } from '../models';

@Component({
  selector: 'app-marketing-socials-eduard',
  imports: [],
  template: `
    <div class="flex items-center justify-center gap-8">
      <!-- linked in -->
      <a [href]="URL_LINKED_IN" target="_blank" rel="noopener noreferrer">
        <svg
          viewBox="0 0 24 24"
      ...
      <a [href]="URL_INSTAGRAM" target="_blank" rel="noopener noreferrer">
        <svg
          viewBox="-7 0 32 32"
          class="fill-wt-gray-medium hover:fill-wt-primary h-[72px] w-[72px] cursor-pointer transition-all duration-700"
          version="1.1"
          xmlns="http://www.w3.org/2000/svg"
        >
...
export class MarketingSocialsEduardComponent {
