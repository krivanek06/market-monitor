    ...
    <>
      <section class="grid place-content-center lg:w-8/12 mx-auto">
        ...
        <p class="text-center text-lg">
          We appreciate your support of trying us out. If you want to help us advance the product, have questions or
          just simply want to connect with us, email to ggfinance.contact.io
        </p>
      </section>
    </>
  );
