...
* `firebase.cloud-functions.json` - Firebase CLI Configuration for this project
...
* `nx g @simondotm/nx-firebase:function my-function --firebaseApp cloud-functions` - Add a firebase function to this project

See the plugin [README](https://github.com/simondotm/nx-firebase/blob/main/README.md) for more information.

## Commands

* `nx run cloud-functions:deploy` - Deploy this app to firebase
* `nx run cloud-functions:serve` - Serve this app using the firebase emulator
* `nx run cloud-functions:build` - Build all functions associated with this app
* `nx run cloud-functions:test` - Test all functions associated with this app
* `nx run cloud-functions:lint` - Lint all functions associated with this app
